...
+ (void) showAlertMessage:(NSString *)strMess autoHide:(BOOL)autoHide {
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:[AppName uppercaseString] message:strMess preferredStyle:UIAlertControllerStyleAlert];
